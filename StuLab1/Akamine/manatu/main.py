...
opening = pygame.mixer.Sound("sound/opening.wav")
opening.set_volume(0.2)
...
hitbox = pygame.Rect(139, 550, 202, 71)
...
def main():
    ...
    while running:
        if b == False:
            ...
            screen.fill((104, 119, 120))
            pygame.display.update()
            for x in range(100):
                screen.blit(logo, (71, x))
                pygame.time.wait(20)
                pygame.display.update()
            pygame.draw.rect(screen, (0, 0, 0), hitbox)
            screen.blit(start,(139,550))
            b = True
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                elif event.button == 1 and hitbox.collidepoint(event.pos):
                    if a == False:
                        opening.play()
        ...
        if me.hp and not paused:
            ...
            if me.active:
                if me.hp >= 100:
                    me.image1 = pygame.image.load("images/me2.png").convert_alpha()
                    me.mask = pygame.mask.from_surface(me.image2)
                    screen.blit(me.image1, me.rect)
                    is_double_bullet = True
                else:
                    me.image1 = pygame.image.load("images/me1.png").convert_alpha()
                ...
                if not(delay % 3):
                    ...
                    if me_destroy_index == 0:
                        ...
                        big_enemies_down = pygame.sprite.spritecollide(
                            me, big_enemies, False, pygame.sprite.collide_mask)
                        if big_enemies_down:
                            me.hp = 0
        ...
        # ゲーム終了画面を描く
            ...
            gameover_text1 = gameover_font.render(
                "Your Score : %d" % score, True, (255, 255, 255))
