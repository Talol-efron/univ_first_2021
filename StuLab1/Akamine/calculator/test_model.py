...
class ModelTest(unittest.TestCase):
    ...
    def testPower(self): # "^"ベキ乗のテスト
        self.model.setValue(2)
        self.model.calculate()  # 演算子キーを押すと計算実行
        self.model.setOperator("^")  # 演算子を保存

        self.model.setValue(8)
        self.model.calculate()  # 演算子キーを押すと計算実行

        self.assertEqual(self.model.result, 2**8)

    def testMod(self): # "%" 割り算の余りのテスト
        self.model.setValue(100)
        self.model.calculate()  # 演算子キーを押すと計算実行
        self.model.setOperator("%")  # 演算子を保存

        self.model.setValue(9)
        self.model.calculate()  # 演算子キーを押すと計算実行
        ...
        self.assertEqual(self.model.result, 4)
